...
public class CreateQuestionActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.create_iv_addnew).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (et_option.getText().toString().equals("") || et_option.getText().toString() == null) {
					...
					//Michael Jordan is the principal owner for which of the below teams?;NC TarHeels;Chicago Bulls;Washington Wizards;Charlotte Hornets;http://ecelebrityfacts.com/uploads/pages/1413445944michael%20jordon.jpg;3 
		...
		findViewById(R.id.create_b_submit).setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Log.d("The child count in the radio group and the currently selected radiobutton index is : ", ((RadioGroup) findViewById(R.id.create_rg_ans)).getChildCount() + "  " +((RadioGroup) findViewById(R.id.create_rg_ans)).getCheckedRadioButtonId()) ;
				
				if ((((RadioGroup) findViewById(R.id.create_rg_ans)).getChildCount() >= 2) && (((RadioGroup) findViewById(R.id.create_rg_ans)).getCheckedRadioButtonId()) != -1){
					Log.d("current value in the options string", sb_options.toString());
